            ...
            <div class="wrapper verify guide">
                ...
                <div class="verify-wrap">
                    ...
                    <div class="guide-tab">
                        ...
                        <div class="fn-none list">
                            <div class="ft-center"> <!-- <svg><use xlink:href="#logo"></use></svg> -->         <img src="${staticServePath}/images/login_logo.png" style="padding: 6px 10px;height:80%;">
                            </div> <br/>
                            <ul>
                                <li>
                                ...
                                <li>
                                    <a href="http://luosh.com/article/1507368648517">${hotKeyLabel}</a>
                                    <span class="ft-gray">${hotKeyTipLabel}</span>
                                </li>
                                <li>
                                    <a href="http://luosh.com/guide/markdown">Markdown ${tutorialLabel}</a>
