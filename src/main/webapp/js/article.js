    ...
    init: function () {
        ...
        var commentEditor = new Editor({
            ...
            toolbar: [
                ...
                {name: 'view'},
                {name: 'fullscreen'},
                {name: 'question', action: 'http://luosh.com/guide/markdown'}
            ],
            extraKeys: {
    ...
    initAudio: function () {
        $('.content-audio').each(function () {
            ...
            new APlayer({
                ...
                music: {
                    title: $it.data('title'),
                    author: '<a href="http://luosh.com/article/1507369770654" target="_blank">音乐分享</a>',
                    url: $it.data('url'),
        ...
        new APlayer({
            ...
            music: {
                title: '语音预览',
                author: '<a href="http://luosh.com/member/v" target="_blank">小薇</a>',
