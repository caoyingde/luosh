...
public class BookMgmtService {
    ...
    public JSONObject shareBook(final JSONObject book, final JSONObject user) {
        ...
        contentBuilder.append("----\n\n").append("## 关于『书单』\n" +
                "\n" +
                "书单是落事网社区的一个纸质书共享活动，所有书均来自捐赠，原则上当前的书籍持有者有义务将书寄送给需要的会员。我们鼓励你在书籍上**留下笔迹**，任何信息都行，让其他人可以看到一些有意思的内容也是蛮不错的 :sweat_smile: \n" +
                "\n" +
                "### 共享意味着什么\n" +
                "\n" +
                ...
                "* 很多社区的书籍交换\n" +
                "\n" +
                "大家的出发点都是想让这个世界变得更好。落事网的『书单』将作为长期活动持续下去，大家随时都能参与进来，让你我的生活变得更丰富有趣！");
